...
@php
    ...
    $badgeFor = function ($run): array {
        ...
        $badge = match ($run->action_type) {
            ...
            'tactical_stage_open_remote_control' => ['bg-warning text-dark', 'Tactical remote control', 'bi-display'],
            ...
            'tactical_stage_set_client_custom_field' => ['bg-danger text-white', 'Tactical client field', 'bi-building-gear'],
