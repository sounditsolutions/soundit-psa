...
/**
 * MCP server config helpers. Scoped staff tokens live in mcp_tokens hash-only
 * rows; the legacy reversible setting remains as the CLI break-glass token.
 */
class McpConfig
{
    ...
    public static function rotateStaffToken(?array $allowedTools = null, ?string $label = null): string
    {
        ...
        McpToken::updateOrCreate(
            ...
            [
                ...
                'token_prefix' => self::tokenPrefix($token),
                'tools' => $tools,
                'last_used_at' => null,
                'revoked_at' => null,
            ],
